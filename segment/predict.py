...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default=ROOT / 'data/video/street_view.mp4', help='file/dir/URL/glob/screen/1(webcam)')
    # default=ROOT / 'data/video/street_view.mp4'
